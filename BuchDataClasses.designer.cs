...
namespace BookCMS_WPF
{
    ...
    partial void OnRolleIDChanged();
		...
		public AutorBuchLink()
		{
			...
			this._Buch = new EntitySet<Buch>(new Action<Buch>(this.attach_Buch), new Action<Buch>(this.detach_Buch));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AutorBuchLink_Buch", Storage="_Buch", ThisKey="BuchID", OtherKey="ID")]
		public EntitySet<Buch> Buch
		{
			get
			{
				return this._Buch;
		...
		private void attach_Buch(Buch entity)
		{
			this.SendPropertyChanging();
			entity.AutorBuchLink = this;
		}
		
		private void detach_Buch(Buch entity)
		{
			this.SendPropertyChanging();
			entity.AutorBuchLink = null;
		}
	...
	public partial class Buch : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Seiten;
    ...
    partial void OnSeitenChanging(System.Nullable<int> value);
    ...
    partial void OnStichworteChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AutorSort", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Seiten", DbType="Int")]
		public System.Nullable<int> Seiten
		{
			get
			{
				return this._Seiten;
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AutorBuchLink_Buch", Storage="_AutorBuchLink", ThisKey="ID", OtherKey="BuchID", IsForeignKey=true)]
		public AutorBuchLink AutorBuchLink
		{
			get
			{
			...
			set
			{
							...
							|| (this._AutorBuchLink.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AutorBuchLink.Entity = null;
						previousValue.Buch.Remove(this);
					}
					this._AutorBuchLink.Entity = value;
					if ((value != null))
					{
						value.Buch.Add(this);
						this._ID = value.BuchID;
					}
					else
					{
						this._ID = default(int);
